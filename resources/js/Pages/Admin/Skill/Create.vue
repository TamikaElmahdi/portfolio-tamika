<template>
  <AdminLayout title="Nouvelle compétence" subtitle="Ajouter une compétence technique">
    <div class="max-w-2xl">
        ...
        <form @submit.prevent="submit" class="space-y-6">
          <div class="grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <input v-model="form.name" type="text" required class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Ex: Vue.js" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.icon" type="text" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Ex: ⚡" />
            </div>
            <div>
...
const form = useForm({ name: '', category: 'frontend', icon: '', level: 75, order: 0 })
const submit = () => form.post('/admin/skills')
</script>
