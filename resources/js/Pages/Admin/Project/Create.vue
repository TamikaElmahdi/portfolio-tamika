            ...
            <div class="sm:col-span-2">
              ...
              >
                <div class="flex flex-col items-center gap-2 text-gray-400">
                  ...
                  <span class="text-sm font-medium">Cliquez ou glissez des images ici</span>
              ...
              <div v-if="previews.length" class="mt-4 grid grid-cols-3 sm:grid-cols-4 gap-3">
                ...
                >
                  ...
                  >✕</button>
                  <span class="absolute bottom-1 left-1 bg-black/50 text-white text-xs px-1.5 py-0.5 rounded">{{ index + 1 }}</span>
                </div>
              </div>
            </div>
          </div>
...
const submit = () => form.post('/admin/projects', { forceFormData: true })
</script>
