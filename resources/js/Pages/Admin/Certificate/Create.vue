<template>
  <AdminLayout title="Nouvelle certification" subtitle="Ajouter une certification">
    <div class="max-w-3xl">
...
const form = useForm({ title_fr: '', title_en: '', organization: '', issued_date: '', expiry_date: '', credential_url: '', description_fr: '', description_en: '', order: 0 })
const submit = () => form.post('/admin/certificates')
</script>
